...
def send_password_reset_email(to_email: str, token: str) -> bool:
    ...
    message = Mail(
        ...
        <div style="font-family: Arial, sans-serif; max-width: 480px; margin: 0 auto;">
            ...
            <h2 style="color: #D4AF7A; text-align: center;">ShopEase</h2>
            <p style="font-size: 15px; line-height: 1.6; color: #333;">
                Someone requested a password reset for your ShopEase account.
...
def send_login_notification_email(to_email: str) -> bool:
    frontend_url = os.getenv("FRONTEND_URL", "https://shop-ease-final.vercel.app")
    ...
    message = Mail(
        ...
        <div style="font-family: Arial, sans-serif; max-width: 480px; margin: 0 auto;">
            ...
            <h2 style="color: #D4AF7A; text-align: center;">ShopEase</h2>
            <p style="font-size: 15px; line-height: 1.6; color: #333;">
                Someone just signed in to your <strong>ShopEase</strong> account using your email address.
            </p>
            <p style="font-size: 15px; line-height: 1.6; color: #333;">
