...
function getThemeColors() {
  const bg = getCSSVar('--bg') || '#1A1815';
  const accent = getCSSVar('--accent') || '#D4AF7A';
  const accentLight = getCSSVar('--accent-light') || '#E8C794';
  const accentDark = getCSSVar('--accent-dark') || '#A68860';
  return {
    backgroundColor: bg,
...
const Lightfall = ({
  ...
  useEffect(() => {
    ...
    const backgroundColor = bgProp || theme.backgroundColor;
