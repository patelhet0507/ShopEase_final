      ...
      >
        ...
        <div className="relative h-44 flex items-center justify-center overflow-hidden select-none"
          ...
          <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2"
            ...
            <Link
              to={`/product/${product.slug || generateSlug(product.name || item.product_name, product.id || item.product_id)}`}
        ...
        <div className="p-4 flex flex-col flex-1 h-full justify-between">
          <div>
            <Link to={`/product/${product.slug || generateSlug(product.name || item.product_name, product.id || item.product_id)}`} className="cursor-pointer">
